...
set_property PACKAGE_PIN R11 [get_ports btn_display_all]
set_property IOSTANDARD LVCMOS33 [get_ports btn_display_all]
...
set_property PACKAGE_PIN K6 [get_ports {num[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {num[3]}]

set_property PACKAGE_PIN L1 [get_ports {num[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {num[2]}]

set_property PACKAGE_PIN M1 [get_ports {num[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {num[1]}]

set_property PACKAGE_PIN K3 [get_ports {num[0]}]
